...
<nav class="h-[65px] bg-[#EF1B17] flex justify-center max-[560px]:justify-start items-center px-4 border border-0  rounded-b-3xl drop-shadow-lg fixed start-0 end-0 z-50">
...
<style>
  ...
  <div class="flex gap-6 max-[560px]:gap-1">
