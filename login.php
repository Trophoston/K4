...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $username = $user_data['email']; // เก็บชื่อผู้ใช้
...
?>
        ...
        <form method="post" action="" class="flex flex-col items-center gap-5 w-screen sm:w-auto px-4">
            ...
            <input type="text" required placeholder="เบอร์โทร หรือ อีเมล์" name="login" class="w-full sm:w-[500px]  rounded-xl h-16 p-4 text-xl border-2 border-[#FF0000] drop-shadow-lg">
            ...
            <a href="./register.php" class="w-full sm:w-[500px] text-center border-2 border-[#ff0000] rounded-2xl h-16 p-4 text-xl hover:bg-[#ddd]  duration-300 bg-[#FFf] drop-shadow-lg text-black text-shadow-lg  ">สมัครสมาชิก</a>
        </form>
